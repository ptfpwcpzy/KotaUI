...
(() => {
  ...
  window.clientModal = function clientModal(existing) {
    ...
    const randomOption = existing ? '' : `<div class="access-toggle"><div><b>随机订阅标识</b><small>订阅路径为随机段/用户名。</small></div><label class="switch" title="随机订阅标识"><input type="checkbox" name="randomSubscriptionSuffix" checked><span></span></label></div>`;
